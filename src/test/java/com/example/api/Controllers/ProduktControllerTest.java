...
public class ProduktControllerTest {
    ...
    public void findAllProduktTest() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/produkt")
                ...
                .andExpect(content().json("[{\"marke\":\"Calvin Klein\",\"farg\":\"svart\",\"storlek\":\"46\",\"pris\":1000,\"antalILager\":1}," +
                        "{\"marke\":\"Adidas\",\"farg\":\"blå\",\"storlek\":\"40\",\"pris\":500,\"antalILager\":1}," +
                        "{\"marke\":\"Nike\",\"farg\":\"vit\",\"storlek\":\"41\",\"pris\":500,\"antalILager\":1}]"));
    }
